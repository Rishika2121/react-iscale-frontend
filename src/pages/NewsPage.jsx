          ...
          {newsItems.map(news => (
            <div key={news.id} style={{
              ...
              <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); window.location.href = '/news-details'; }} style={{ color: 'var(--text-primary)', fontWeight: 700, fontSize: 13, textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 4 }}>

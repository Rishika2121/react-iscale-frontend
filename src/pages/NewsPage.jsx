              ...
              <div key={news.id} className="news-card-interactive colorful-glow-border" style={{
                ...
                <div className="news-card-image-wrap" style={{ width: '100%', height: 220, background: 'var(--bg-secondary)', position: 'relative', borderTopLeftRadius: 15, borderTopRightRadius: 15, overflow: 'hidden' }}>
                  {news.img ? (
                    ...
                    <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'linear-gradient(135deg, rgba(237, 28, 36, 0.05), rgba(59, 130, 246, 0.05))', color: 'var(--text-muted)', fontSize: 14 }}>
              ...
              const content = (
                <>
                  {post.img ? (
                    ...
                    <div style={{ width: 64, height: 64, background: 'linear-gradient(135deg, rgba(237, 28, 36, 0.05), rgba(59, 130, 246, 0.05))', borderRadius: 8, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-primary)', color: 'var(--text-primary)', paddingTop: 80, paddingBottom: 80 }}>
      <div className="container" style={{ maxWidth: 800, margin: '0 auto', padding: '0 24px' }}>
        ...
        <h1 style={{ fontSize: 40, fontWeight: 900, color: 'var(--text-primary)', marginBottom: 20, lineHeight: 1.2 }}>The iScale received recognition from Indian Startup News</h1>
        <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 40 }}>
          ...
          <span style={{ color: 'var(--text-muted)', fontSize: 14 }}>Oct 24, 2024</span>
        </div>
        ...
        <div style={{ fontSize: 17, lineHeight: 1.8, color: 'var(--text-secondary)' }}>
          ...
          <h3 style={{ fontSize: 24, fontWeight: 800, color: 'var(--text-primary)', marginTop: 40, marginBottom: 16 }}>Empowering the Youth</h3>
          ...
          <blockquote style={{ borderLeft: '4px solid var(--red)', paddingLeft: 24, margin: '40px 0', fontSize: 20, fontStyle: 'italic', color: 'var(--text-primary)' }}>
